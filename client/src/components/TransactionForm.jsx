        ...
        trigger={transactionTriggerButton}>
            ...
            <Modal.Content>
                ...
                <Form onSubmit={onSubmit}>
                    <Form.Field>
                        <Form.Input placeholder="To" name="to" value={inputs.to} onChange={(e) => onChange("to", e)} />
                    </Form.Field>
                    <Form.Field>
                        <Form.Input placeholder="Value" name="value" value={inputs.value} onChange={(e) => onChange("value", e)} />
                    </Form.Field>
                    <Form.Field>
                        <Form.Input placeholder="Data" name="data" value={inputs.data} onChange={(e) => onChange("data", e)} />
                    </Form.Field>
